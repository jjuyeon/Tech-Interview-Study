...
#### 추상 클래스
  ...
  - a. 미완성된 메소드인 추상 메소드를 최소 한 개 이상 포함하고 있다.
    ...
    ```
  - b. 추상 메소드가 없어도 추상 클래스로 선언할 수 있다.
  ...
  - 모든 추상 메소드를 구현해야 하는 것은 아니다.
  - **제약 사항**
    - 추상 메소드가 아닌 일반 메소드, 멤버도 포함할 수 있다. 
...
```
- 외부 저장소로 저장되는 데이터는 짧은 만료시간의 데이터를 제외하고 
  자바 직렬화를 사용하지 않도록 한다.
